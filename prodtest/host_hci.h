...
#define CMD__REGISTER_RW_OP_READ_SN   (0)
#define CMD__REGISTER_RW_OP_WRITE_SN  (1)

#define CMD__REGISTER_RW_OP_READ_SWVERSION   (2)
#define CMD__REGISTER_RW_OP_WRITE_SWVERSION  (3)

#define CMD__REGISTER_RW_OP_READ_FLAG   (4)
#define CMD__REGISTER_RW_OP_WRITE_FLAG  (5)
...
#define CMD__REGISTER_RW_OP_WRITE_FPSENSER_ZERO  (11)
